        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayerOneScore = table.Column<double>(nullable: false),
                    PlayerTwoScore = table.Column<double>(nullable: false),
                    PhysicalTableId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Games", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Games_PhysicalTables_PhysicalTableId",
                        column: x => x.PhysicalTableId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Games_PhysicalTableId",
                table: "Games",
                column: "PhysicalTableId");
